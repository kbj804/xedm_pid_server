...
def sample_request():
    access_key = "7e17f20b-fc11-4e35-a575-c72d9d9a-b033-47c4-bc28-89c83d031c25"
    secret_key = "pG87a41CEs7L6Wl8bkzvMln0YE0fQP1BhgS63KTk"
...
# print(requests.get("http://127.0.0.1:8000/api/pid").text)
